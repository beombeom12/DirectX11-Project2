...
HRESULT CGraphic_Device::Ready_Graphic_Device(HWND hWnd, GRAPHIC_DESC::WINMODE WinMode, _uint iWinCX, _uint iWinCY, ID3D11Device** ppDeviceOut, ID3D11DeviceContext** ppContextOut)
{
	_uint		iFlag = 0;
	...
	m_pContext->OMSetRenderTargets(1, &m_pBackBufferRTV,
		m_pDepthStencilView);

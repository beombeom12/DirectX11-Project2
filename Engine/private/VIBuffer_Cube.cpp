...
#pragma region VERTEX_BUFFER
	...
	pVertices[0].vPosition = _float3(-10.5f, 10.5f, -10.5f);
	pVertices[0].vTexUV = pVertices[0].vPosition;

	pVertices[1].vPosition = _float3(10.5f, 10.5f, -10.5f);
	pVertices[1].vTexUV = pVertices[1].vPosition;

	pVertices[2].vPosition = _float3(10.5f, -10.5f, -10.5f);
	pVertices[2].vTexUV = pVertices[2].vPosition;

	pVertices[3].vPosition = _float3(-10.5f, -10.5f, -10.5f);
	pVertices[3].vTexUV = pVertices[3].vPosition;

	pVertices[4].vPosition = _float3(-10.5f, 10.5f, 10.5f);
	pVertices[4].vTexUV = pVertices[4].vPosition;

	pVertices[5].vPosition = _float3(10.5f, 10.5f, 10.5f);
	pVertices[5].vTexUV = pVertices[5].vPosition;

	pVertices[6].vPosition = _float3(10.5f, -10.5f, 10.5f);
	pVertices[6].vTexUV = pVertices[6].vPosition;

	pVertices[7].vPosition = _float3(-10.5f, -10.5f, 10.5f);

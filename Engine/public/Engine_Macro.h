...
#define ENGINE_OPEN												\
CGameInstance* ENGINE = CGameInstance::GetInstance();			\
Safe_AddRef(ENGINE);

#define ENGINE_CLOSE											\
Safe_Release(ENGINE);											\

#define MANAGER_OPEN(MANAGERNAME)								\
MANAGERNAME* MANAGER = MANAGERNAME::GetInstance();				\
Safe_AddRef(MANAGER);

#define MANAGER_CLOSE											\

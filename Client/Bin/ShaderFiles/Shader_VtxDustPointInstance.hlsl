...
float g_fX_UV = 0.f, g_fY_UV = 0.f;

bool g_bUseDiscardColorOptionMin = false;
bool g_bUseDiscardColorOptionMax = false;
float3 g_vDiscardColorMin;
float3 g_vDiscardColorMax;


bool g_bGreenOption = false;
...
PS_OUT PS_MAIN(PS_IN In)
{
	...
	Out.vColor.rgb = float3(0.95f, 0.95f, 0.7f);

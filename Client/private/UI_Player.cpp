...
HRESULT CUI_Player::Initialize_Prototype(OBJECT_ID eID, _uint eUIType)
{
...
HRESULT CUI_Player::Initialize_Clone(void * pArg)
{
	...
	{
		m_UIDesc.Size = _float4((_float)110.f, (_float)110.f, 0.f, 1.f);
...
_uint CUI_Player::Tick(_double TimeDelta)
{
	return __super::Tick(TimeDelta);
}

void CUI_Player::Late_Tick(_double TimeDelta)
{
...
HRESULT CUI_Player::Render(void)
{
...
HRESULT CUI_Player::Setup_Component(void)
{
	ENGINE_OPEN;
	/* For.Com_Renderer */
	...
	/* For.Com_Shader */
	if (FAILED(__super::Add_Component(ENGINE->Get_StaticLevelIndex(), TEXT("Prototype_Component_Shader_VtxTexture"), TEXT("Com_Shader"),
...
CUI_Player * CUI_Player::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext, OBJECT_ID eID, UITYPE eType)
{
...
CGameObject * CUI_Player::Clone(void * pArg)
{
	...
	{
		MSG_BOX("Failed to Crate Clone : CUI_Player");
		Safe_Release(pInstance);
		return nullptr;
	}
	return pInstance;

...
HRESULT CBackGround::Initialize_Prototype(OBJECT_ID eID)
{
...
HRESULT CBackGround::Initialize(void * pArg)
{
	...
	m_GameObjectDesc.TransformDesc.fSpeedPerSec = 5.f;
	m_GameObjectDesc.TransformDesc.fRotationPerSec = XMConvertToRadians(90.f);
...
HRESULT CBackGround::SetUp_Space(void)
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	...
	m_matWorld.m[0][0] = m_fSizeX;
	m_matWorld.m[1][1] = m_fSizeY;
...
CBackGround * CBackGround::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext, OBJECT_ID eID)
{
